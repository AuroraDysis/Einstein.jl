"""
    sphankel(r::AbstractVector{T}) where {T<:Union{AbstractFloat,Complex{<:AbstractFloat}}
...
"""
function ultra_sphankel(r::AbstractVector{T}) where {T<:AbstractFloatOrComplex}
