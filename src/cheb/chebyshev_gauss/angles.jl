...
- `n`: Number of points
"""
function cheb_gauss_angles(::Type{TF}, n::Integer) where {TF<:AbstractFloat}
...
function cheb_gauss_angles(n::Integer)
    return cheb_gauss_angles(Float64, n)
end

export cheb_gauss_angles
