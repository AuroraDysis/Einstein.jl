...
"""
    cheb_coeffs_cumsummat([TR=Float64], n::Integer) where {TR<:AbstractFloat}
...
"""
function cheb_coeffs_cumsummat(::Type{TR}, n::Integer) where {TR<:AbstractFloat}
    nm1 = n - 1
...
function cheb_coeffs_cumsummat(n::Integer)
...
function cheb_coeffs_cumsummat(n::Integer, x_min::Float64, x_max::Float64)
