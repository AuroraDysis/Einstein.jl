...
"""
function cheb1_rectdiff(::Type{TR}, m::TI, n::TI) where {TR<:AbstractFloat,TI<:Integer}
...
export cheb1_rectdiff

@testset "cheb1_rectdiff" begin
    tol = 100 * eps(Float64)

    D45 = cheb1_rectdiff(Float64, 4, 5)
    D45_res = [
    ...
    D56 = cheb1_rectdiff(Float64, 5, 6)
    D56_res = [
