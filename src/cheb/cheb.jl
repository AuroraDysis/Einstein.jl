...
include("chebtech1/points.jl")
include("chebtech1/angles.jl")
include("chebtech1/synthesis.jl")
include("chebtech1/analysis.jl")
include("chebtech1/barycentric_weights.jl")
include("chebtech1/quadrature_weights.jl")
include("chebtech1/differentiation_matrix.jl")
include("chebtech1/analysis_matrix.jl")
include("chebtech1/synthesis_matrix.jl")
include("chebtech1/integration_matrix.jl")
