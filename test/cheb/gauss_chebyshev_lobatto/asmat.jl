...
@testitem "vals2coeffs_matrix, coeffs2vals_matrix" begin
    ...
    x = GaussChebyshevLobatto.points(Float64, n)
    A = GaussChebyshevLobatto.vals2coeffs_matrix(Float64, n)
    S = GaussChebyshevLobatto.coeffs2vals_matrix(Float64, n)
    ...
    @testset "Transform and recover" begin
        ...
        f = @. 3x^2 + 2x - 1
        coeffs = A * f
        coeffs2 = GaussChebyshevLobatto.vals2coeffs(f)
